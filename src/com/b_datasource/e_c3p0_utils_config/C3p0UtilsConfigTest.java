package com.b_datasource.e_c3p0_utils_config;
...
public class C3p0UtilsConfigTest {

	@Test
	public void testF1Select() throws Exception{
		
		Connection conn = C3p0UtilsConfig.getConnection();
		...
		//释放资源
		C3p0UtilsConfig.getClose(conn, pstmt, rs);
	}
	...
	public void testF2Update() throws Exception{
		...
		//释放资源
		C3p0UtilsConfig.getClose(conn, pstmt, null);
	}
